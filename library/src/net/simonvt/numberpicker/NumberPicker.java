...
public class NumberPicker extends LinearLayout {
	...
	private void tryComputeMaxWidth() {
		...
		if (mDisplayedValues == null) {
			...
			for (int i = 0; i < valueCount; i++) {
				final float textWidth = mSelectorWheelPaint.measureText(mDisplayedValues[i]) + 20;
	...
	public void setMaxWidth(String longestText) {
		if (!mComputeMaxWidth) {
			return;
		}
		int maxTextWidth = (int) mSelectorWheelPaint.measureText(longestText) + 20;
	...
	protected void onDraw(Canvas canvas) {
		...
		if (mSelectionDivider != null) {
			...
			mSelectionDivider.setBounds(7, topOfTopDivider, getRight()-7, bottomOfTopDivider);
			mSelectionDivider.draw(canvas);

			// draw the bottom divider
			int bottomOfBottomDivider = mBottomSelectionDividerBottom;
			int topOfBottomDivider = bottomOfBottomDivider - mSelectionDividerHeight;
			mSelectionDivider.setBounds(7, topOfBottomDivider, getRight()-7, bottomOfBottomDivider);
			mSelectionDivider.draw(canvas);
		}
	}
